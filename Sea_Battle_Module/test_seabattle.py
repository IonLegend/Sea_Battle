"""Тесты билиотеки - 28"""
import pytest
from main_module import Field, SHOT_HIT, SHOT_MISS, SHOT_ERROR, SHOT_KILL, SHOT_WAS_BEATEN, CLEAR, SHIP, FLEET_LENGTHS
...
def test_can_place_ship():
    ...
    field = Field()
    assert field.can_place_ship('a1-a2-a3', 3) is True
